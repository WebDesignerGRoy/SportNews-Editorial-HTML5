function testTheiaStickySidebars() {
    var t = {};
    t.scrollTopStep = 1, t.currentScrollTop = 0, t.values = null, window.scrollTo(0, 1), window.scrollTo(0, 0), $(window).scroll(function(t) {
        return function(e) {
            var i = [];
            if ($(".theiaStickySidebar").each(function() {
                    i.push($(this).offset().top)
                }), null != t.values) {
                for (var n = !0, s = 0; s < i.length; s++) {
                    var o = Math.abs(i[s] - t.values[s]);
                    o > 1 && (n = !1, console.log("Offset difference for sidebar #" + (s + 1) + " is " + o + "px"), $($(".theiaStickySidebar")[s]).css("background", "yellow"))
                }
                if (0 == n) return $(this).unbind(e), void alert("Bummer. Offset difference is bigger than 1px for some sidebars, which will be highlighted in yellow. Check the logs. Aborting.")
            }
            t.values = i, t.currentScrollTop < $(document).height() - $(window).height() && 1 == t.scrollTopStep ? (t.currentScrollTop += t.scrollTopStep, window.scrollTo(0, t.currentScrollTop)) : t.currentScrollTop > 0 ? (t.scrollTopStep = -1, t.currentScrollTop += t.scrollTopStep, window.scrollTo(0, t.currentScrollTop)) : ($(this).unbind(e), alert("Great success!"))
        }
    }(t))
}! function(t, e) {
    "use strict";
    ...
    function s(t, e, i) {
        ...
        }) : kt.test(e) ? ft.filter(e, t, i) : (e = ft.filter(e, t), ft.grep(t, function(t) {
    ...
    function p(t, e, i) {
        ...
        if (void 0 === i && 1 === t.nodeType)
            if (n = "data-" + e.replace(Lt, "-$&").toLowerCase(), i = t.getAttribute(n), "string" == typeof i) {
                try {
                    i = d(i)
                } catch (t) {}
                Ht.set(t, e, i)
    ...
    function f(t, e, i, n) {
        var s, o = 1,
            ...
            u = (ft.cssNumber[e] || "px" !== h && +l) && jt.exec(ft.css(t, e));
        if (u && u[3] !== h) {
            h = h || u[3], i = i || [], u = +l || 1;
            do o = o || ".5", u /= o, ft.style(t, e, u + h); while (o !== (o = a() / l) && 1 !== o && --r)
        }
    ...
    function m(t) {
        var e, i = t.ownerDocument,
            n = t.nodeName,
            s = $t[n];
        return s ? s : (e = i.body.appendChild(i.createElement(n)), s = ft.css(e, "display"), e.parentNode.removeChild(e), "none" === s && (s = "block"), $t[n] = s, s)
    }

    function g(t, e) {
        for (var i, n, s = [], o = 0, r = t.length; o < r; o++) n = t[o], n.style && (i = n.style.display, e ? ("none" === i && (s[o] = zt.get(n, "display") || null, s[o] || (n.style.display = "")), "" === n.style.display && qt(n) && (s[o] = m(n))) : "none" !== i && (s[o] = "none", zt.set(n, "display", i)));
    ...
    function _(t, e, i, n, s) {
        for (var o, r, a, l, h, u, c = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)
            ...
            for (r = r || c.appendChild(e.createElement("div")), a = (Ut.exec(o) || ["", ""])[1].toLowerCase(), l = Xt[a] || Xt._default, r.innerHTML = l[1] + ft.htmlPrefilter(o) + l[2], u = l[0]; u--;) r = r.lastChild;
            ft.merge(d, r.childNodes), r = c.firstChild, r.textContent = ""
        } else d.push(e.createTextNode(o));
        for (c.textContent = "", p = 0; o = d[p++];)
            if (n && ft.inArray(o, n) > -1) s && s.push(o);
            else if (h = ft.contains(o.ownerDocument, o), r = v(c.appendChild(o), "script"), h && y(r), i)
    ...
    function I(t, e) {
        var i, n, s, o, r, a, l, h;
        if (1 === e.nodeType) {
            if (zt.hasData(t) && (o = zt.access(t), r = zt.set(e, o), h = o.events)) {
    ...
    function P(t, e, n, s) {
        ...
        if (d && (o = _(e, t[0].ownerDocument, !1, t, s), r = o.firstChild, 1 === o.childNodes.length && (o = r), r || s)) {
            for (a = ft.map(v(o, "script"), T), l = a.length; c < d; c++) h = o, c !== p && (h = ft.clone(h, !0, !0), l && ft.merge(a, v(h, "script"))), n.call(t[c], h, c);
            if (l)
                for (u = a[a.length - 1].ownerDocument, ft.map(a, D), c = 0; c < l; c++) h = a[c], Vt.test(h.type || "") && !zt.access(h, "globalEval") && ft.contains(u, h) && (h.src ? ft._evalUrl && ft._evalUrl(h.src) : i(h.textContent.replace(se, ""), u))
        }
        return t
    }

    function M(t, e, i) {
        for (var n, s = e ? ft.filter(e, t) : t, o = 0; null != (n = s[o]); o++) i || 1 !== n.nodeType || ft.cleanData(v(n)), n.parentNode && (i && ft.contains(n.ownerDocument, n) && y(v(n, "script")), n.parentNode.removeChild(n));
        return t
    }
    ...
    function z(t, e, i, n, s) {
        var o, r = 0;
        for (o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0; o < 4; o += 2) "margin" === i && (r += ft.css(t, i + Rt[o], !0, s)), n ? ("content" === i && (r -= ft.css(t, "padding" + Rt[o], !0, s)), "margin" !== i && (r -= ft.css(t, "border" + Rt[o] + "Width", !0, s))) : (r += ft.css(t, "padding" + Rt[o], !0, s), "padding" !== i && (r += ft.css(t, "border" + Rt[o] + "Width", !0, s)));
        return r
    }
    ...
    function H(t, e, i) {
        ...
        if (t.getClientRects().length && (n = t.getBoundingClientRect()[e]), n <= 0 || null == n) {
            if (n = A(t, e, o), (n < 0 || null == n) && (n = t.style[e]), re.test(n)) return n;
            s = r && (dt.boxSizingReliable() || n === t.style[e]), n = parseFloat(n) || 0
        }
        return n + z(t, e, i || (r ? "border" : "content"), s, o) + "px"
    }
    ...
    function L() {
        fe && (t.requestAnimationFrame(L), ft.fx.tick())
    }
    ...
    function q(t, e, i) {
        ...
        if (l = !ft.isEmptyObject(e), l || !ft.isEmptyObject(p)) {
            c && 1 === t.nodeType && (i.overflow = [f.overflow, f.overflowX, f.overflowY], h = v && v.display, null == h && (h = zt.get(t, "display")), u = ft.css(t, "display"), "none" === u && (h ? u = h : (g([t], !0), h = t.style.display || h, u = ft.css(t, "display"), g([t]))), ("inline" === u || "inline-block" === u && null != h) && "none" === ft.css(t, "float") && (l || (d.done(function() {
                f.display = h
            }), null == h && (u = f.display, h = "none" === u ? "" : u)), f.display = "inline-block")), i.overflow && (f.overflow = "hidden", d.always(function() {
                f.overflow = i.overflow[0], f.overflowX = i.overflow[1], f.overflowY = i.overflow[2]
            })), l = !1;
            for (n in p) l || (v ? "hidden" in v && (m = v.hidden) : v = zt.access(t, "fxshow", {
                display: h
            }), o && (v.hidden = !m), m && g([t], !0), d.done(function() {
                m || g([t]), zt.remove(t, "fxshow");
                for (n in p) ft.style(t, n, p[n])
            })), l = R(m ? v[n] : 0, n, d), n in v || (v[n] = l.start, m && (l.end = l.start, l.start = 0))
        }
    }
    ...
    function $(t, e, i) {
        ...
        for (B(u, h.opts.specialEasing); o < r; o++)
            if (n = $.prefilters[o].call(h, t, u, h.opts)) return ft.isFunction(n.stop) && (ft._queueHooks(h.elem, h.opts.queue).stop = ft.proxy(n.stop, n)), n;
        return ft.map(u, R, h), ft.isFunction(h.opts.start) && h.opts.start.call(t, h), ft.fx.timer(ft.extend(l, {
            elem: t,
            anim: h,
            queue: h.opts.queue
    ...
    function V(t, e, i, n) {
        ...
        if (ft.isArray(e)) ft.each(e, function(e, s) {
            i || De.test(t) ? n(t, s) : V(t + "[" + ("object" == typeof s && null != s ? e : "") + "]", s, i, n)
        });
    ...
    ft.fn = ft.prototype = {
        ...
        isPlainObject: function(t) {
            var e, i;
            return !(!t || "[object Object]" !== lt.call(t) || (e = it(t)) && (i = ht.call(e, "constructor") && e.constructor, "function" != typeof i || ut.call(i) !== ct))
        },
    ...
    var _t = function(t) {
        function e(t, e, i, n) {
            var s, o, r, a, l, h, u, d = e && e.ownerDocument,
                f = e ? e.nodeType : 9;
            if (i = i || [], "string" != typeof t || !t || 1 !== f && 9 !== f && 11 !== f) return i;
            if (!n && ((e ? e.ownerDocument || e : R) !== N && E(e), e = e || N, z)) {
                if (11 !== f && (l = vt.exec(t)))
                    if (s = l[1]) {
                        if (9 === f) {
                        ...
                        if ((s = l[3]) && x.getElementsByClassName && e.getElementsByClassName) return J.apply(i, e.getElementsByClassName(s)), i
                    }
                if (x.qsa && !U[t + " "] && (!H || !H.test(t))) {
                    if (1 !== f) d = e, u = t;
                    else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(wt, xt) : e.setAttribute("id", a = j), h = D(t), o = h.length; o--;) h[o] = "#" + a + " " + p(h[o]);
        ...
        function f(t, e, i) {
            ...
            return e.first ? function(e, i, s) {
                ...
                if (l) {
                    ...
                    for (; e = e[n];)
                        if (1 === e.nodeType || r)
                            if (c = e[j] || (e[j] = {}), u = c[e.uniqueID] || (c[e.uniqueID] = {}), s && s === e.nodeName.toLowerCase()) e = e[n] || e;
                            else {
                                if ((h = u[o]) && h[0] === q && h[1] === a) return d[2] = h[2];
        ...
        function y(t, e, i, s, o, r) {
            return s && !s[j] && (s = y(s)), o && !o[j] && (o = y(o, r)), n(function(n, r, a, l) {
                var h, u, c, d = [],
                    p = [],
                    f = r.length,
                    ...
                    _ = i ? o || (n ? t : f || s) ? [] : r : y;
                if (i && i(y, _, a, l), s)
                    for (h = v(_, p), s(h, [], a, l), u = h.length; u--;)(c = h[u]) && (_[p[u]] = !(y[p[u]] = c));
                if (n) {
                    if (o || t) {
                        if (o) {
                ...
                } else _ = v(_ === r ? _.splice(f, _.length) : _), o ? o(null, r, _, l) : J.apply(r, _)
            })
        }
        ...
        function _(t) {
            for (var e, i, n, s = t.length, o = C.relative[t[0].type], r = o || C.relative[" "], a = o ? 1 : 0, l = f(function(t) {
                ...
                if (i = C.relative[t[a].type]) u = [f(m(u), i)];
                else {
                    if (i = C.filter[t[a].type].apply(null, t[a].matches), i[j]) {
                        ...
                        return y(a > 1 && m(u), a > 1 && p(t.slice(0, a - 1).concat({
                            value: " " === t[a - 2].type ? "*" : ""
                        })).replace(at, "$1"), i, a < n && _(t.slice(a, n)), n < s && _(t = t.slice(n)), n < s && p(t))
                    }
                    u.push(i)
                }
            return m(u)
            ...
            var s = i.length > 0,
                ...
                r = function(n, r, a, l, h) {
                    var u, c, d, p = 0,
                        ...
                        w = _.length;
                    for (h && (P = r === N || r || h); f !== w && null != (u = _[f]); f++) {
                        if (o && u) {
                            for (c = 0, r || u.ownerDocument === N || (E(u), a = !z); d = t[c++];)
                                if (d(u, r || N, a)) {
                                    l.push(u);
                                    break
                                }
                    ...
                    if (p += f, s && f !== p) {
                        ...
                        J.apply(l, g), h && !n && g.length > 0 && p + i.length > 1 && e.uniqueSort(l)
                    }
                    return h && (q = b, P = y), m
                };
            return s ? n(r) : r
        }
        var w, x, C, k, T, D, I, S, P, M, A, E, N, O, z, H, W, L, F, j = "sizzle" + 1 * new Date,
            R = t.document,
            q = 0,
            B = 0,
            $ = i(),
        ...
        x = e.support = {}, T = e.isXML = function(t) {
            ...
            return n !== N && 9 === n.nodeType && n.documentElement ? (N = n, O = N.documentElement, z = !T(N), R !== N && (i = N.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", Ct, !1) : i.attachEvent && i.attachEvent("onunload", Ct)), x.attributes = s(function(t) {
            ...
            }, W = [], H = [], (x.qsa = gt.test(N.querySelectorAll)) && (s(function(t) {
                O.appendChild(t).innerHTML = "<a id='" + j + "'></a><select id='" + j + "-\r\\' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && H.push("[*^$]=" + it + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || H.push("\\[" + it + "*(?:value|" + et + ")"), t.querySelectorAll("[id~=" + j + "-]").length || H.push("~="), t.querySelectorAll(":checked").length || H.push(":checked"), t.querySelectorAll("a#" + j + "+*").length || H.push(".#.+[+~]")
            }), s(function(t) {
                t.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
                var e = N.createElement("input");
                e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && H.push("name" + it + "*[*^$|!~]?="), 2 !== t.querySelectorAll(":enabled").length && H.push(":enabled", ":disabled"), O.appendChild(t).disabled = !0, 2 !== t.querySelectorAll(":disabled").length && H.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), H.push(",.*:")
            })), (x.matchesSelector = gt.test(L = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && s(function(t) {
                x.disconnectedMatch = L.call(t, "*"), L.call(t, "[s!='']:x"), W.push("!=", ot)
            }), H = H.length && new RegExp(H.join("|")), W = W.length && new RegExp(W.join("|")), e = gt.test(O.compareDocumentPosition), F = e || gt.test(O.contains) ? function(t, e) {
            ...
            if ((t.ownerDocument || t) !== N && E(t), i = i.replace(ut, "='$1']"), x.matchesSelector && z && !U[i + " "] && (!W || !W.test(i)) && (!H || !H.test(i))) try {
                var n = L.call(t, i);
                if (n || x.disconnectedMatch || t.document && 11 !== t.document.nodeType) return n
            } catch (t) {}
            return e(i, N, null, [t]).length > 0
        }, e.contains = function(t, e) {
            return (t.ownerDocument || t) !== N && E(t), F(t, e)
        }, e.attr = function(t, e) {
            (t.ownerDocument || t) !== N && E(t);
            var i = C.attrHandle[e.toLowerCase()],
                n = i && X.call(C.attrHandle, e.toLowerCase()) ? i(t, e, !z) : void 0;
            ...
            var e, i = [],
                n = 0,
                s = 0;
            if (A = !x.detectDuplicates, M = !x.sortStable && t.slice(0), t.sort(V), A) {
                    ...
                    return 1 === n && 0 === s ? function(t) {
                        ...
                        if (g) {
                            ...
                            if (f = [r ? g.firstChild : g.lastChild], r && y) {
                                for (d = g, c = d[j] || (d[j] = {}), u = c[d.uniqueID] || (c[d.uniqueID] = {}), h = u[t] || [], p = h[0] === q && h[1], _ = p && h[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (_ = p = 0) || f.pop();)
                                    if (1 === d.nodeType && ++_ && d === e) {
                                        u[t] = [q, p, _];
                                        break
                                    }
                            } else if (y && (d = e, c = d[j] || (d[j] = {}), u = c[d.uniqueID] || (c[d.uniqueID] = {}), h = u[t] || [], p = h[0] === q && h[1], _ = p), _ === !1)
                                for (;
                                    (d = ++p && d && d[m] || (_ = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++_ || (y && (c = d[j] || (d[j] = {}), u = c[d.uniqueID] || (c[d.uniqueID] = {}), u[t] = [q, _]), d !== e)););
        ...
        return d.prototype = C.filters = C.pseudos, C.setFilters = new d, D = e.tokenize = function(t, i) {
            ...
            for (a = t, l = [], h = C.preFilter; a;) {
                ...
                for (r in C.filter) !(s = pt[r].exec(a)) || h[r] && !(s = h[r](s)) || (n = s.shift(), o.push({
                    value: n,
                    type: r,
                    matches: s
                }), a = a.slice(n.length));
            ...
            var i, n = [],
                ...
                o = U[t + " "];
            if (!o) {
                for (e || (e = D(t)), i = e.length; i--;) o = _(e[i]), o[j] ? n.push(o) : s.push(o);
            ...
            if (i = i || [], 1 === u.length) {
                if (o = u[0] = u[0].slice(0), o.length > 2 && "ID" === (r = o[0]).type && 9 === e.nodeType && z && C.relative[o[1].type]) {
                    if (e = (C.find.ID(r.matches[0].replace(_t, bt), e) || [])[0], !e) return i;
                    h && (e = e.parentNode), t = t.slice(o.shift().value.length)
                }
                for (s = pt.needsContext.test(t) ? 0 : o.length; s-- && (r = o[s], !C.relative[a = r.type]);)
                    if ((l = C.find[a]) && (n = l(r.matches[0].replace(_t, bt), yt.test(o[0].type) && c(e.parentNode) || e))) {
                        if (o.splice(s, 1), t = n.length && p(o), !t) return J.apply(i, n), i;
                        break
                    }
            }
            return (h || I(t, u))(n, e, !z, i, !e || yt.test(t) && c(e.parentNode) || e), i
        }, x.sortStable = j.split("").sort(V).join("") === j, x.detectDuplicates = !!A, E(), x.sortDetached = s(function(t) {
    ...
    ft.fn.extend({
        ...
        ft.fn[t] = function(i, n) {
            ...
            return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (s = ft.filter(n, s)), this.length > 1 && (Pt[t] || ft.uniqueSort(s), St.test(t) && s.reverse()), this.pushStack(s)
        }
    });
    var Mt = /[^\x20\t\r\n\f]+/g;
                                ...
                                var h = this,
                                    ...
                                    c = function() {
                                        ...
                                        if (!(e < r)) {
                                            ...
                                            c = t && ("object" == typeof t || "function" == typeof t) && t.then, ft.isFunction(c) ? s ? c.call(t, o(r, i, a, s), o(r, i, l, s)) : (r++, c.call(t, o(r, i, a, s), o(r, i, l, s), o(r, i, a, i.notifyWith))) : (n !== a && (h = void 0, u = [t]), (s || i.resolveWith)(h, u))
                                        }
                                    },
                                    d = s ? c : function() {
                                        try {
                                            ...
                                            ft.Deferred.exceptionHook && ft.Deferred.exceptionHook(t, d.stackTrace), e + 1 >= r && (n !== l && (h = void 0, u = [t]), i.rejectWith(h, u))
                                        }
                                    };
    ...
    }), ft.ready.then = Et.then, "complete" === et.readyState || "loading" !== et.readyState && !et.documentElement.doScroll ? t.setTimeout(ft.ready) : (et.addEventListener("DOMContentLoaded", u), t.addEventListener("load", u));
    ...
    c.uid = 1, c.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== n) {
                if (void 0 !== e) {
                    ft.isArray(e) ? e = e.map(ft.camelCase) : (e = ft.camelCase(e), e = e in n ? [e] : e.match(Mt) || []), i = e.length;
                    for (; i--;) delete n[e[i]]
    ...
    ft.extend({
        ...
        data: function(t, e) {
            var i, n, s, o = this[0],
                r = o && o.attributes;
            if (void 0 === t) {
                if (this.length && (s = Ht.get(o), 1 === o.nodeType && !zt.get(o, "hasDataAttrs"))) {
        ...
        queue: function(t, e, i) {
            var n;
            if (t) return e = (e || "fx") + "queue", n = zt.get(t, e), i && (!n || ft.isArray(i) ? n = zt.access(t, e, ft.makeArray(i)) : n.push(i)), n || []
        },
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;) i = zt.get(o[r], t + "queueHooks"), i && i.empty && (n++, i.empty.add(a));
            return a(), s.promise(e)
        }
    });
    var Ft = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        jt = new RegExp("^(?:([+-])=|)(" + Ft + ")([a-z%]*)$", "i"),
        ...
        add: function(t, e, i, n, s) {
            ...
            if (g)
                for (i.handler && (o = i, i = o.handler, s = o.selector), s && ft.find.matchesSelector(Gt, s), i.guid || (i.guid = ft.guid++), (l = g.events) || (l = g.events = {}), (r = g.handle) || (r = g.handle = function(e) {
                    ...
                    }), e = (e || "").match(Mt) || [""], h = e.length; h--;) a = Zt.exec(e[h]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p && (c = ft.event.special[p] || {}, p = (s ? c.delegateType : c.bindType) || p, c = ft.event.special[p] || {}, u = ft.extend({
                    type: p,
                    origType: m,
                    data: n,
                    handler: i,
                    ...
                    namespace: f.join(".")
                }, o), (d = l[p]) || (d = l[p] = [], d.delegateCount = 0, c.setup && c.setup.call(t, n, f, r) !== !1 || t.addEventListener && t.addEventListener(p, r)), c.add && (c.add.call(t, u), u.handler.guid || (u.handler.guid = i.guid)), s ? d.splice(d.delegateCount++, 0, u) : d.push(u), ft.event.global[p] = !0)
        },
        remove: function(t, e, i, n, s) {
            var o, r, a, l, h, u, c, d, p, f, m, g = zt.hasData(t) && zt.get(t);
            if (g && (l = g.events)) {
                for (e = (e || "").match(Mt) || [""], h = e.length; h--;)
                    if (a = Zt.exec(e[h]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                        for (c = ft.event.special[p] || {}, p = (n ? c.delegateType : c.bindType) || p, d = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = o = d.length; o--;) u = d[o], !s && m !== u.origType || i && i.guid !== u.guid || a && !a.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (d.splice(o, 1), u.selector && d.delegateCount--, c.remove && c.remove.call(t, u));
                ...
                ft.isEmptyObject(l) && zt.remove(t, "handle events")
            }
        },
        dispatch: function(t) {
            var e, i, n, s, o, r, a = ft.event.fix(t),
                l = new Array(arguments.length),
                h = (zt.get(this, "events") || {})[a.type] || [],
    ...
    ft.extend({
        ...
        clone: function(t, e, i) {
            ...
            if (!(dt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ft.isXMLDoc(t)))
                for (r = v(a), o = v(t), n = 0, s = o.length; n < s; n++) S(o[n], r[n]);
            if (e)
                if (i)
    ...
    ft.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var s, o, r, a = ft.camelCase(e),
                    l = t.style;
                return e = ft.cssProps[a] || (ft.cssProps[a] = N(a) || a), r = ft.cssHooks[e] || ft.cssHooks[a], void 0 === i ? r && "get" in r && void 0 !== (s = r.get(t, !1, n)) ? s : l[e] : (o = typeof i, "string" === o && (s = jt.exec(i)) && s[1] && (i = f(t, e, s), o = "number"), void(null != i && i === i && ("number" === o && (i += s && s[3] || (ft.cssNumber[a] ? "" : "px")), dt.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), r && "set" in r && void 0 === (i = r.set(t, i, n)) || (l[e] = i))))
            }
        },
        css: function(t, e, i, n) {
            var s, o, r, a = ft.camelCase(e);
            return e = ft.cssProps[a] || (ft.cssProps[a] = N(a) || a), r = ft.cssHooks[e] || ft.cssHooks[a], r && "get" in r && (s = r.get(t, !0, i)), void 0 === s && (s = A(t, e, n)), "normal" === s && e in ue && (s = ue[e]), "" === i || i ? (o = parseFloat(s), i === !0 || isFinite(o) ? o || 0 : s) : s
        }
        ...
        ft.cssHooks[e] = {
            ...
            set: function(t, i, n) {
                var s, o = n && ae(t),
                    r = n && z(t, e, n, "border-box" === ft.css(t, "boxSizing", !1, o), o);
                return r && (s = jt.exec(i)) && "px" !== (s[3] || "px") && (t.style[e] = i, i = ft.css(t, e)), O(t, i, r)
            }
        }
    }), ft.cssHooks.marginLeft = E(dt.reliableMarginLeft, function(t, e) {
        if (e) return (parseFloat(A(t, "marginLeft")) || t.getBoundingClientRect().left - Bt(t, {
            marginLeft: 0
        }, function() {
    ...
    ft.Animation = ft.extend($, {
            ...
            fe || (fe = t.requestAnimationFrame ? t.requestAnimationFrame(L) : t.setInterval(ft.fx.tick, ft.fx.interval))
        }, ft.fx.stop = function() {
    ...
    ft.fn.extend({
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ft.isFunction(t) ? this.each(function(i) {
                ...
                var e, n, s, o;
                if ("string" === i)
                    for (n = 0, s = ft(this), o = t.match(Mt) || []; e = o[n++];) s.hasClass(e) ? s.removeClass(e) : s.addClass(e);
                else void 0 !== t && "boolean" !== i || (e = U(this), e && zt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || t === !1 ? "" : zt.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, i, n = 0;
    ...
    ft.extend(ft.event, {
        trigger: function(e, i, n, s) {
            var o, r, a, l, h, u, c, d = [n || et],
                p = ht.call(e, "type") ? e.type : e,
                f = ht.call(e, "namespace") ? e.namespace.split(".") : [];
            if (r = a = n = n || et, 3 !== n.nodeType && 8 !== n.nodeType && !xe.test(p + ft.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), h = p.indexOf(":") < 0 && "on" + p, e = e[ft.expando] ? e : new ft.Event(p, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : ft.makeArray(i, [e]), c = ft.event.special[p] || {}, s || !c.trigger || c.trigger.apply(n, i) !== !1)) {
                ...
                for (o = 0;
                    (r = d[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? l : c.bindType || p, u = (zt.get(r, "events") || {})[e.type] && zt.get(r, "handle"), u && u.apply(r, i), u = h && r[h], u && u.apply && Ot(r) && (e.result = u.apply(r, i), e.result === !1 && e.preventDefault());
                return e.type = p, s || e.isDefaultPrevented() || c._default && c._default.apply(d.pop(), i) !== !1 || !Ot(n) || h && ft.isFunction(n[p]) && !ft.isWindow(n) && (a = n[h], a && (n[h] = null), ft.event.triggered = p, n[p](), ft.event.triggered = void 0, a && (n[h] = a)), e.result
            }
        },
    ...
    ft.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !ft(this).is(":disabled") && Pe.test(this.nodeName) && !Se.test(t) && (this.checked || !Yt.test(t))
            }).map(function(t, e) {
                var i = ft(this).val();
    ...
    je.href = Ce.href, ft.extend({
        ...
        ajax: function(e, i) {
            function n(e, i, n, a) {
                var h, d, p, b, w, x = i;
                u || (u = !0, l && t.clearTimeout(l), s = void 0, r = a || "", C.readyState = e > 0 ? 4 : 0, h = e >= 200 && e < 300 || 304 === e, n && (b = Q(f, C, n)), b = J(f, b, C, h), h ? (f.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (ft.lastModified[o] = w), w = C.getResponseHeader("etag"), w && (ft.etag[o] = w)), 204 === e || "HEAD" === f.type ? x = "nocontent" : 304 === e ? x = "notmodified" : (x = b.state, d = b.data, p = b.error, h = !p)) : (p = x, !e && x || (x = "error", e < 0 && (e = 0))), C.status = e, C.statusText = (i || x) + "", h ? v.resolveWith(m, [d, x, C]) : v.rejectWith(m, [C, x, p]), C.statusCode(_), _ = void 0, c && g.trigger(h ? "ajaxSuccess" : "ajaxError", [C, f, h ? d : p]), y.fireWith(m, [C, x]), c && (g.trigger("ajaxComplete", [C, f]), --ft.active || ft.event.trigger("ajaxStop")))
            }
            ...
            if (v.promise(C), f.url = ((e || f.url || Ce.href) + "").replace(He, Ce.protocol + "//"), f.type = i.method || i.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(Mt) || [""], null == f.crossDomain) {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = ft.param(f.data, f.traditional)), K(We, f, i, C), u) return C;
            c = ft.event && f.global, c && 0 === ft.active++ && ft.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !ze.test(f.type), o = f.url.replace(Ae, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Me, "+")) : (p = f.url.slice(o.length), f.data && (o += (Te.test(o) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (o = o.replace(Ee, "$1"), p = (Te.test(o) ? "&" : "?") + "_=" + ke++ + p), f.url = o + p), f.ifModified && (ft.lastModified[o] && C.setRequestHeader("If-Modified-Since", ft.lastModified[o]), ft.etag[o] && C.setRequestHeader("If-None-Match", ft.etag[o])), (f.data && f.hasContent && f.contentType !== !1 || i.contentType) && C.setRequestHeader("Content-Type", f.contentType), C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Fe + "; q=0.01" : "") : f.accepts["*"]);
            for (d in f.headers) C.setRequestHeader(d, f.headers[d]);
            if (f.beforeSend && (f.beforeSend.call(m, C, f) === !1 || u)) return C.abort();
            if (x = "abort", y.add(f.complete), C.done(f.success), C.fail(f.error), s = K(Le, f, i, C)) {
    ...
    dt.cors = !!qe && "withCredentials" in qe, dt.ajax = qe = !!qe, ft.ajaxTransport(function(e) {
        var i, n;
        if (dt.cors || qe && !e.crossDomain) return {
            send: function(s, o) {
                var r, a = e.xhr();
    ...
    ft.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = Be.pop() || ft.expando + "_" + ke++;
            return this[t] = !0, t
        }
    }), ft.ajaxPrefilter("json jsonp", function(e, i, n) {
        var s, o, r, a = e.jsonp !== !1 && ($e.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && $e.test(e.data) && "data");
        if (a || "jsonp" === e.dataTypes[0]) return s = e.jsonpCallback = ft.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace($e, "$1" + s) : e.jsonp !== !1 && (e.url += (Te.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function() {
        ...
        var n, s, o;
        return e || (dt.createHTMLDocument ? (e = et.implementation.createHTMLDocument(""), n = e.createElement("base"), n.href = et.location.href, e.head.appendChild(n)) : e = et), s = Ct.exec(t), o = !i && [], s ? [e.createElement(s[1])] : (s = _([t], e, o), o && o.length && ft(o).remove(), ft.merge([], s.childNodes))
        ...
        offset: function(t) {
            ...
            return o ? o.getClientRects().length ? (n = o.getBoundingClientRect(), n.width || n.height ? (s = o.ownerDocument, i = Z(s), e = s.documentElement, {
    ...
    function(t, e, i) {
        ...
        s(t, "attrFn", r || {}, "jQuery.attrFn is deprecated"), t.attr = function(e, s, o, l) {
            var h = s.toLowerCase(),
                f = e && e.nodeType;
            return l && (a.length < 4 && n("jQuery.fn.attr( props, pass ) is deprecated"), e && !c.test(f) && (r ? s in r : t.isFunction(t.fn[s]))) ? t(e)[s](o) : ("type" === s && o !== i && u.test(e.nodeName) && e.parentNode && n("Can't change the 'type' of an input or button in IE 6/7/8"), !t.attrHooks[h] && d.test(h) && (t.attrHooks[h] = {
                get: function(e, n) {
                    var s, o = t.prop(e, n);
        ...
        var C;
        for (C in v) Object.prototype.hasOwnProperty.call(v, C) && (t.find[C] = v[C]);
        ...
        t.swap && t.each(["height", "width", "reliableMarginRight"], function(e, i) {
            ...
            n && (t.cssHooks[i].get = function() {
                var t;
                return k = !0, t = n.apply(this, arguments), k = !1, t
            })
        }), t.swap = function(t, e, i, s) {
            var o, r, a = {};
            k || n("jQuery.swap() is undocumented and deprecated");
        ...
        t.fn.data = function(e) {
            var s, o, r = this[0];
            return !r || "events" !== e || 1 !== arguments.length || (s = t.data(r, e), o = t._data(r, e), s !== i && s !== o || o === i) ? T.apply(this, arguments) : (n("Use of jQuery.fn.data('events') is deprecated"), o)
        };
        var D = /\/(java|ecma)script/i;
        t.clean || (t.clean = function(e, i, s, o) {
            ...
            if (t.merge(u, t.buildFragment(e, i).childNodes), s)
                for (l = function(t) {
                        return !t.type || D.test(t.type) ? o ? o.push(t.parentNode ? t.parentNode.removeChild(t) : t) : s.appendChild(t) : void 0
                    }, r = 0; null != (a = u[r]); r++) t.nodeName(a, "script") && l(a) || (s.appendChild(a), "undefined" != typeof a.getElementsByTagName && (h = t.grep(t.merge([], a.getElementsByTagName("script")), l), u.splice.apply(u, [r + 1, 0].concat(h)), r += h.length));
            return u
        });
        var I = t.event.add,
            S = t.event.remove,
        ...
        t.event.props && "attrChange" !== t.event.props[0] && t.event.props.unshift("attrChange", "attrName", "relatedNode", "srcElement"), t.event.dispatch && s(t.event, "handle", t.event.dispatch, "jQuery.event.handle is undocumented and deprecated"), t.event.add = function(t, e, i, s, o) {
            t !== document && z.test(e) && n("AJAX events should be attached to document: " + e), I.call(this, t, W(e || ""), i, s, o)
        }, t.event.remove = function(t, e, i, n, s) {
            S.call(this, t, W(e) || "", i, n, s)
            ...
            if (!t.isFunction(e) || !t.isFunction(i)) return M.apply(this, arguments);
            ...
            return i || z.test(t) || n("Global events are undocumented and deprecated"), P.call(this, t, e, i || document, s)
        ...
        var L = t.fn.andSelf || t.fn.addBack,
            F = t.fn.find;
    ...
    function(t) {
        ...
        t.cleanData = function(e) {
            ...
            function() {
                ...
                t.position = {
                    ...
                    s = t.extend({}, s);
                    var c, p, f, m, g, v, y = t(s.of),
                        _ = t.position.getWithinInfo(s.within),
                        b = t.position.getScrollInfo(_),
                        w = (s.collision || "flip").split(" "),
                        x = {};
                    return v = n(y), y[0].preventDefault && (s.at = "left top"), p = v.width, f = v.height, m = v.offset, g = t.extend({}, m), t.each(["my", "at"], function() {
                        ...
                        var n, a, l = t(this),
                            ...
                            k = u + v + i(this, "marginBottom") + b.height,
                            T = t.extend({}, g),
                    ...
                    flip: {
                        left: function(t, e) {
                            var i, n, s = e.within,
                                ...
                                f = -2 * e.offset[0];
                            0 > u ? (i = t.left + d + p + f + e.collisionWidth - a - o, (0 > i || r(u) > i) && (t.left += d + p + f)) : c > 0 && (n = t.left - e.collisionPosition.marginLeft + d + p + f - l, (n > 0 || c > r(n)) && (t.left += d + p + f))
                        },
                        top: function(t, e) {
                            var i, n, s = e.within,
                                ...
                                m = -2 * e.offset[1];
                            0 > u ? (n = t.top + p + f + m + e.collisionHeight - a - o, (0 > n || r(u) > n) && (t.top += p + f + m)) : c > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - l, (i > 0 || c > r(i)) && (t.top += p + f + m))
                        }
                    },
                    flipfit: {
                        left: function() {
        ...
        t(document).on("mouseup", function() {
            ...
            drag: function(e, i, n) {
                ...
                for (d = n.snapElements.length - 1; d >= 0; d--) l = n.snapElements[d].left - n.margins.left, h = l + n.snapElements[d].width, u = n.snapElements[d].top - n.margins.top, c = u + n.snapElements[d].height, l - m > v || g > h + m || u - m > _ || y > c + m || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                ...
                })), n.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = m >= Math.abs(u - _), o = m >= Math.abs(c - y), r = m >= Math.abs(l - v), a = m >= Math.abs(h - g), s && (i.position.top = n._convertPositionTo("relative", {
                    ...
                    top: 0,
                    left: h
                }).left)), p = s || o || r || a, "outer" !== f.snapMode && (s = m >= Math.abs(u - y), o = m >= Math.abs(c - _), r = m >= Math.abs(l - g), a = m >= Math.abs(h - v), s && (i.position.top = n._convertPositionTo("relative", {
                    top: u,
                    left: 0
                }).top), o && (i.position.top = n._convertPositionTo("relative", {
        ...
        t.extend(n.prototype, {
            ...
            _generateHTML: function(t) {
                var e, i, n, s, o, r, a, l, h, u, c, d, p, f, m, g, v, y, _, b, w, x, C, k, T, D, I, S, P, M, A, E, N, O, z, H, W, L, F, j = new Date,
                    ...
                    for (C = "", this.maxRows = 4, k = 0; U[1] > k; k++) {
                        if (T = this._daylightSavingAdjust(new Date(tt, Z, t.selectedDay)), D = " ui-corner-all", I = "", K) {
                            if (I += "<div class='ui-datepicker-group", U[1] > 1) switch (k) {
                                case 0:
                                    I += " ui-datepicker-group-first", D = " ui-corner-" + (q ? "right" : "left");
                                    break;
                                case U[1] - 1:
                                    I += " ui-datepicker-group-last", D = " ui-corner-" + (q ? "left" : "right");
                                    break;
                                default:
                        ...
                        for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === x ? q ? o : n : "") + (/all|right/.test(D) && 0 === x ? q ? n : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || k > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", S = c ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; 7 > w; w++) P = (w + u) % 7, S += "<th scope='col'" + ((w + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[P] + "'>" + p[P] + "</span></th>";
                        for (I += S + "</tr></thead><tbody>", M = this._getDaysInMonth(tt, Z), tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, M)), A = (this._getFirstDayOfMonth(tt, Z) - u + 7) % 7, E = Math.ceil((A + M) / 7), N = K && this.maxRows > E ? this.maxRows : E, this.maxRows = N, O = this._daylightSavingAdjust(new Date(tt, Z, 1 - A)), z = 0; N > z; z++) {
                            for (I += "<tr>", H = c ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(O) + "</td>" : "", w = 0; 7 > w; w++) W = g ? g.apply(t.input ? t.input[0] : null, [O]) : [!0, ""], L = O.getMonth() !== Z, F = L && !y || !W[0] || Q && Q > O || J && O > J, H += "<td class='" + ((w + u + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (L ? " ui-datepicker-other-month" : "") + (O.getTime() === T.getTime() && Z === t.selectedMonth && t._keyEvent || _.getTime() === O.getTime() && _.getTime() === T.getTime() ? " " + this._dayOverClass : "") + (F ? " " + this._unselectableClass + " ui-state-disabled" : "") + (L && !v ? "" : " " + W[1] + (O.getTime() === G.getTime() ? " " + this._currentClass : "") + (O.getTime() === R.getTime() ? " ui-datepicker-today" : "")) + "'" + (L && !v || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") + (F ? "" : " data-handler='selectDay' data-event='click' data-month='" + O.getMonth() + "' data-year='" + O.getFullYear() + "'") + ">" + (L && !v ? "&#xa0;" : F ? "<span class='ui-state-default'>" + O.getDate() + "</span>" : "<a class='ui-state-default" + (O.getTime() === R.getTime() ? " ui-state-highlight" : "") + (O.getTime() === G.getTime() ? " ui-state-active" : "") + (L ? " ui-priority-secondary" : "") + "' href='#'>" + O.getDate() + "</a>") + "</td>", O.setDate(O.getDate() + 1), O = this._daylightSavingAdjust(O);
                            I += H + "</tr>"
                        }
            ...
            _generateMonthYearHeader: function(t, e, i, n, s, o, r, a) {
                ...
                if (o || !g) b += "<span class='ui-datepicker-month'>" + r[e] + "</span>";
                    ...
                    for (l = n && n.getFullYear() === i, h = s && s.getFullYear() === i, b += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", u = 0; 12 > u; u++)(!l || u >= n.getMonth()) && (!h || s.getMonth() >= u) && (b += "<option value='" + u + "'" + (u === e ? " selected='selected'" : "") + ">" + a[u] + "</option>");
                    b += "</select>"
                }
            ...
            _eventHandler: function(e) {
                ...
                e.preventDefault(), o.hasClass("ui-state-disabled") || o.hasClass("ui-tabs-loading") || this.running || r && !i.collapsible || this._trigger("beforeActivate", e, u) === !1 || (i.active = !a && this.tabs.index(o), this.active = r ? t() : o, this.xhr && this.xhr.abort(), h.length || l.length || t.error("jQuery UI Tabs: Mismatching fragment identifier."), l.length && this.load(this.tabs.index(o), e), this._toggle(e, u))
            },
                ...
                t.expr && t.expr.filters && t.expr.filters.animated && (t.expr.filters.animated = function(e) {
                    ...
                    effect: function() {
                        function i(e) {
                            ...
                            var a = t(this);
                            n.mode = u.shift(), t.uiBackCompat === !1 || o ? "none" === n.mode ? (a[h](), r()) : s.call(a[0], n, i) : (a.is(":hidden") ? "hide" === h : "show" === h) ? (a[h](), r()) : s.call(a[0], n, r)
                        }
        ...
        t.effects.define("blind", "hide", function(e, i) {
            ...
            var n, s, o, r = t(this),
                ...
                y = 0,
                _ = r.queue().length;
            for (t.effects.createPlaceholder(r), o = r.css(g), c || (c = r["top" === g ? "outerHeight" : "outerWidth"]() / 3), h && (s = {
                    opacity: 1
                }, s[g] = o, r.css("opacity", 0).css(g, v ? 2 * -c : 2 * c).animate(s, f, m)), l && (c /= Math.pow(2, d - 1)), s = {}, s[g] = o; d > y; y++) n = {}, n[g] = (v ? "-=" : "+=") + c, r.animate(n, f, m).animate(s, f, m), c = l ? 2 * c : c / 2;
            l && (n = {
                opacity: 0
            }, n[g] = (v ? "-=" : "+=") + c, r.animate(n, f, m)), r.queue(i), t.effects.unshift(r, _, p + 1)
            ...
            t.effects.createPlaceholder(r), "show" === u && (o = v, v = y, y = o), s = {
                from: {
                    y: v.height / g.height,
                    x: v.width / g.width
                },
            ...
            }, ("box" === d || "both" === d) && (s.from.y !== s.to.y && (v = t.effects.setTransition(r, l, s.from.y, v), y = t.effects.setTransition(r, l, s.to.y, y)), s.from.x !== s.to.x && (v = t.effects.setTransition(r, h, s.from.x, v), y = t.effects.setTransition(r, h, s.to.x, y))), ("content" === d || "both" === d) && s.from.y !== s.to.y && (v = t.effects.setTransition(r, a, s.from.y, v), y = t.effects.setTransition(r, a, s.to.y, y)), p && (n = t.effects.getBaseline(p, g), v.top = (g.outerHeight - v.outerHeight) * n.y + m.top, v.left = (g.outerWidth - v.outerWidth) * n.x + m.left, y.top = (g.outerHeight - y.outerHeight) * n.y + m.top, y.left = (g.outerWidth - y.outerWidth) * n.x + m.left), r.css(v), ("content" === d || "both" === d) && (l = l.concat(["marginTop", "marginBottom"]).concat(a), h = h.concat(["marginLeft", "marginRight"]), r.find("*[width]").each(function() {
                var i = t(this),
                ...
                complete: function() {
                    var e = r.offset();
                    0 === y.opacity && r.css("opacity", v.opacity), c || (r.css("position", "static" === f ? "relative" : f).offset(e), t.effects.saveStyle(r)), i()
                }
            })
        ...
        var y;
        t.uiBackCompat !== !1 && (y = t.effects.define("transfer", function(e, i) {
            t(this).transfer(e, i)
        }))
    }),
    function(t, e) {
        ...
        t.fn.imagesLoaded = function(n) {
            ...
            function o(e, n) {
                e.src === i || -1 !== t.inArray(e, u) || (u.push(e), n ? d.push(e) : c.push(e), t.data(e, "imagesLoaded", {
                    isBroken: n,
                    src: e.src
                }), l && a.notifyWith(t(e), [n, h, t(c), t(d)]), h.length === u.length && (setTimeout(s), h.unbind(".imagesLoaded")))
            }
            var r = this,
            ...
            function a(t) {
                if (s(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    var v = o.paddingLeft + o.paddingRight,
                        ...
                        C = a && c,
                        k = e(i.width);
                    k !== !1 && (o.width = k + (C ? 0 : v + w));
                    var T = e(i.height);
                    return T !== !1 && (o.height = T + (C ? 0 : y + x)), o.innerWidth = o.width - (v + w), o.innerHeight = o.height - (y + x), o.outerWidth = o.width + _, o.outerHeight = o.height + b, o
                }
            }
    ...
    function(t) {
        t.flexslider = function(e, i) {
            ...
            t.data(e, "flexslider", n), p = {
                ...
                touch: function() {
                    function t(t) {
                        n.animating ? t.preventDefault() : 1 === t.touches.length && (n.pause(), p = l ? n.h : n.w, m = Number(new Date), d = u && h && n.animatingTo === n.last ? 0 : u && h ? n.limit - (n.itemW + s.itemMargin) * n.move * n.animatingTo : u && n.currentSlide === n.last ? n.limit : u ? (n.itemW + s.itemMargin) * n.move * n.currentSlide : h ? (n.last - n.currentSlide + n.cloneOffset) * p : (n.currentSlide + n.cloneOffset) * p, r = l ? t.touches[0].pageY : t.touches[0].pageX, a = l ? t.touches[0].pageX : t.touches[0].pageY, e.addEventListener("touchmove", i, !1), e.addEventListener("touchend", o, !1))
                    }
                ...
                resize: function() {
                    !n.animating && n.is(":visible") && (u || n.doMath(), c ? p.smoothHeight() : u ? (n.slides.width(n.computedW), n.update(n.pagingCount), n.setProps()) : l ? (n.viewport.height(n.h), n.setProps(n.h, "setTotal")) : (s.smoothHeight && p.smoothHeight(), n.newSlides.width(n.computedW), n.setProps(n.computedW, "setTotal")))
                },
                ...
                if (d && 1 === n.pagingCount && (n.direction = n.currentItem < e ? "next" : "prev"), !n.animating && (n.canAdvance(e, m) || a) && n.is(":visible")) {
                    ...
                    if (n.animating = !0, n.animatingTo = e, s.before(n), i && n.pause(), n.syncExists && !m && p.sync("animate"), s.controlNav && p.controlNav.active(), u || n.slides.removeClass(o + "active-slide").eq(e).addClass(o + "active-slide"), n.atEnd = 0 === e || e === n.last, s.directionNav && p.directionNav.update(), e === n.last && (s.end(n), s.animationLoop || n.pause()), c) r ? (n.slides.eq(n.currentSlide).css({
                        opacity: 0
                    }), n.slides.eq(e).css({
                        opacity: 1
                        ...
                        var v, y, _, b = l ? n.slides.filter(":first").height() : n.computedW;
                        u ? (v = s.itemWidth > n.w ? 2 * s.itemMargin : s.itemMargin, _ = (n.itemW + v) * n.move * n.animatingTo, y = _ > n.limit && 1 !== n.visible ? n.limit : _) : y = 0 === n.currentSlide && e === n.count - 1 && s.animationLoop && "next" !== n.direction ? h ? (n.count + n.cloneOffset) * b : 0 : n.currentSlide === n.last && 0 === e && s.animationLoop && "prev" !== n.direction ? h ? 0 : (n.count + 1) * b : h ? (n.count - 1 - e + n.cloneOffset) * b : (e + n.cloneOffset) * b, n.setProps(y, "", s.animationSpeed), n.transitions ? (s.animationLoop && n.atEnd || (n.animating = !1, n.currentSlide = n.animatingTo), n.container.unbind("webkitTransitionEnd transitionend"), n.container.bind("webkitTransitionEnd transitionend", function() {
                            n.wrapup(b)
                ...
                c || u || (0 === n.currentSlide && n.animatingTo === n.last && s.animationLoop ? n.setProps(t, "jumpEnd") : n.currentSlide === n.last && 0 === n.animatingTo && s.animationLoop && n.setProps(t, "jumpStart")), n.animating = !1, n.currentSlide = n.animatingTo, s.after(n)
    ...
    function(t) {
        t.fn.theiaStickySidebar = function(e) {
            function i(e, i) {
                var s = n(e, i);
                s || (console.log("TST: Body width smaller than options.minWidth. Init is delayed."), t(document).scroll(function(e, i) {
                    return function(s) {
                        var o = n(e, i);
                        o && t(this).unbind(s)
                    }
            ...
            function s(e, i) {
                e.initialized = !0, t("head").append(t('<style>.theiaStickySidebar:after {content: ""; display: table; clear: both;}</style>')), i.each(function() {
                    ...
                    }), s.stickySidebar = s.sidebar.find(".theiaStickySidebar"), 0 == s.stickySidebar.length && (s.sidebar.find("script").remove(), s.stickySidebar = t("<div>").addClass("theiaStickySidebar").append(s.sidebar.children()), s.sidebar.append(s.stickySidebar)), s.marginTop = parseInt(s.sidebar.css("margin-top")), s.marginBottom = parseInt(s.sidebar.css("margin-bottom")), s.paddingTop = parseInt(s.sidebar.css("padding-top")), s.paddingBottom = parseInt(s.sidebar.css("padding-bottom"));
                    ...
                    s.stickySidebar.css("padding-top", 1), s.stickySidebar.css("padding-bottom", 1), o -= s.stickySidebar.offset().top, r = s.stickySidebar.outerHeight() - r - o, 0 == o ? (s.stickySidebar.css("padding-top", 0), s.stickySidebarPaddingTop = 0) : s.stickySidebarPaddingTop = 1, 0 == r ? (s.stickySidebar.css("padding-bottom", 0), s.stickySidebarPaddingBottom = 0) : s.stickySidebarPaddingBottom = 1, s.previousScrollTop = null, s.fixedScrollTop = 0, i(), s.onScroll = function(s) {
                        if (s.stickySidebar.is(":visible")) {
                            ...
                            if (o >= s.container.offset().top + (s.paddingTop + s.marginTop - s.options.additionalMarginTop)) {
                                var a, l = s.paddingTop + s.marginTop + e.additionalMarginTop,
                                ...
                                "fixed" == s.stickySidebar.css("position") && "modern" == s.options.sidebarBehavior && (g += v), "legacy" == s.options.sidebarBehavior && (g = a - s.stickySidebar.outerHeight(), g = Math.max(g, a - s.stickySidebar.outerHeight())), g = v > 0 ? Math.min(g, d) : Math.max(g, a - s.stickySidebar.outerHeight()), g = Math.max(g, f), g = Math.min(g, m - s.stickySidebar.outerHeight());
                            ...
                            if ("fixed" == r) s.stickySidebar.css({
                                ...
                                var _ = {};
                                "absolute" != s.stickySidebar.css("position") && (_.position = "absolute", _.top = o + g - s.sidebar.offset().top - s.stickySidebarPaddingTop - s.stickySidebarPaddingBottom), _.width = s.sidebar.width(), _.left = "", s.stickySidebar.css(_)
                            } else "static" == r && i();
